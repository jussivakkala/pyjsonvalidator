import unit_test.globvars as globvars
...
content = [
    {
        ...
        "balances": [
            {"balanceid": "CREDIT", "bal_type": "money", "start": "500", "end": "499"},  # Error 'CREDIT' planted in on purpose
    ...
    },
    {
        ...
        "services": [
            {"service_type": "3", "identifier": globvars.id_abel,  "price": "1.00000",  "action": globvars.someconst, "someval": "",
             "subitems" : []
             }
        ]
    },
